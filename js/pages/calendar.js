...
//
// Moved verbatim from index.html, with one correction: the day cells built
// their date key with toISOString(), which is UTC. It now uses dateStr() so a
// cell is keyed to the local calendar day. See the header of js/util.js.
// ---------------------------------------------------------------------------
